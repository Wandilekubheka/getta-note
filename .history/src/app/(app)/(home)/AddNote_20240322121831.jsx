...
const AddNote = () => {
  ...
  return (
    <ScrollView className=" bg-stone-950 flex-1  justify-between">
      <Stack.Screen
        options={{
          headerShown: true,
      ...
      <TouchableOpacity
        ...
        className=" absolute  bottom-0 right-0 w-12 h-12 bg-neutral-800 justify-center items-center rounded-md"
      >
