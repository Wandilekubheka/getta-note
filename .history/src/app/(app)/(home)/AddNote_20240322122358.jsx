...
const AddNote = () => {
  ...
  return (
    <View className=" bg-stone-300 flex-1">
      <ScrollView style={{ flex: 1 bg-blue-100}}>
        {/* <Stack.Screen
          options={{
            headerShown: true,
        ...
        <View>
          ...
          <View className=" px-5 flex-row border border-neutral-500 rounded-md mt-2 justify-between">
            <TextInput
        ...
        <TouchableOpacity
          ...
          className=" self-end justify-self-end mt w-12 h-12 bg-neutral-800 justify-center items-center rounded-md"
        >
